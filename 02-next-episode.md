---
title: "A New Lesson Has Appeared!"
teaching: 10
exercises: 2
---
...
Try using `sessionInfo()` to print information about your current R session.
...
loaded via a namespace (and not attached):
 ...
 [7] highr_0.9            knitr_1.32           stringr_1.4.0       
[10] xfun_0.22            evaluate_0.14        sandpaper_0.0.0.9022
```
